...
## Kørt, afventer commit

- `2026-09-21-error-hints.sql` — **kørt 2026-09-21.** `dbSchema.sql` er opdateret. Filen slettes efter den er committet — ikke før: den er lige nu den eneste kilde i repoet til de ni samtale-/besked-funktioner, der aldrig er blevet dokumenteret i `dbSchema.sql`.
