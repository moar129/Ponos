...
| US-45 | Se dashboard | Critical | Done | `Dashboard.tsx` omskrevet fra placeholder til Oversigt/Organisation/Administration-faner - se US-65-rækken. Manuelt testet og bekræftet virkende i browseren |
