...
US-59 og US-60 er nu manuelt testet i browseren og bekræftet virkende (se status-tabellen) - migration kørt, "Anmod om medlemskab"- og "Opret organisation"-faner bekræftet virkende, herunder at oprettelse af en ny organisation automatisk skifter aktiv organisation. US-61 er den sidste brik i medlemskabsmodellen (many-to-many + "aktiv organisation") fra US-59 - databasedesignet (`memberships`-tabellen, bypass-flag-mønsteret) understøtter den allerede uden yderligere migration af selve modellen; mangler kun en DELETE-policy/RPC med "sidste admin"-tjek + genvalg af aktiv organisation. Ingen spec skrevet på forhånd endnu - en session skal selv lægge en plan først, efter samme mønster som "US-59-spec" nedenfor.
