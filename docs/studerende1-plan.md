...
US-58/59/60/61 (opret organisation, medlemskabsmodel + "aktiv organisation", flere organisationer, forlad organisation) er nu alle Done og manuelt testet og bekræftet virkende i browseren (se status-tabellen) - inkl. 3 bugs fundet og rettet undervejs i selve testen (se US-59-rækkens note): forkert profil-synlighed på tværs af organisationer, forkert rollevisning for ikke-aktive organisationer, og manglende cache-invalidering ved brugerskift (login som en anden bruger). Næste skridt jf. "Anbefalet rækkefølge": Dashboard, bygget fra start med "aktiv organisation" i tankerne (US-46/47 skal tælle items/opgaver for den AKTIVE organisation, ikke en fast organisation).
