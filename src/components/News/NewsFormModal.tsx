...
export function NewsFormModal({ isOpen, onClose, editingNews }: NewsFormModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" role="dialog" aria-modal="true">
            <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white border border-border-gray rounded-lg shadow-xl p-6 relative">
                <button
                    type="button"
                    onClick={onClose}
                    aria-label="Luk"
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <button
                            ...
                            onClick={onClose}
                            disabled={isSaving}
                            className="rounded-md border border-border-gray bg-bg-gray px-4 py-2 font-medium text-secondary hover:bg-border-gray transition-colors disabled:opacity-60"
                        >
                            Annuller
                        </button>
                    </div>
