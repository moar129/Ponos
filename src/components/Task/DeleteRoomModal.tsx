                ...
                <div className="space-y-5">
                    ...
                    {selectedRoomId && (
                        <div>
                            ...
                            {roomTasks.length > 0 ? (
                                <div className="max-h-60 space-y-2 overflow-y-auto rounded-lg border border-border-gray p-2">
                                    {roomTasks.map((task) => {
                                        const isSelected =
                                            ...
                                            <label
                                                ...
                                                className={`flex cursor-pointer items-start gap-3 rounded-lg border p-3 transition ${
                                                    isSelected
                                                        ...
                                                        : 'border-border-gray hover:bg-bg-gray'
                                                }`}
                                            >
                                                <input
                                                    type="checkbox"
                                                    ...
                                                    className="mt-1 h-4 w-4 rounded border-border-gray text-accent focus:ring-accent"
                                                />
                                ...
                                <div className="rounded-lg bg-bg-gray/40 p-4">
