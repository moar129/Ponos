                ...
                <div className="space-y-5">
                    ...
                    {selectedRoomId && (
                        <div>
                            ...
                            {roomTasks.length > 0 ? (
                                <div className="max-h-60 space-y-2 overflow-y-auto rounded-lg border border-slate-800 p-2">
                                    {roomTasks.map((task) => {
                                        const isSelected =
                                        ...
                                        return (
                                            ...
                                            >
                                                <input
                                                    ...
                                                    className="mt-1 h-4 w-4 rounded border-slate-600 bg-slate-950 text-accent focus:ring-accent"
                                                />
