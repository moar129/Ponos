...
export function RichTextEditor({ value, onChange, id, placeholder }: RichTextEditorProps) {
    ...
    const buttonClass = (isActive: boolean) =>
        `p-1.5 rounded-md transition-colors ${
            isActive ? 'bg-slate-800 text-slate-100' : 'text-slate-400 hover:text-slate-100 hover:bg-slate-800'
        }`

    return (
        <div className="rounded-md border border-slate-700 bg-slate-900 focus-within:ring-2 focus-within:ring-accent">
            <div className="flex flex-wrap items-center gap-1 border-b border-slate-700 px-2 py-1.5">
                ...
                <select
                    ...
                    className="text-sm text-slate-300 bg-transparent rounded-md px-1 py-1 hover:bg-slate-800 focus:outline-none"
                >
            ...
            {linkDraft !== null && (
                <div className="flex flex-wrap items-center gap-2 border-b border-slate-700 px-2 py-2 bg-slate-800/40">
                    <input
                        ref={linkTextRef}
                        type="text"
                        ...
                        className="flex-1 min-w-40 rounded-md border border-slate-700 bg-slate-900 text-slate-100 px-2 py-1 text-sm focus:outline-none focus:border-accent"
                    />
                    <input
                        type="text"
                        value={linkDraft.url}
            ...
            <div
                ...
                className="rich-text min-h-40 max-h-96 overflow-y-auto px-3 py-2 text-slate-100 focus:outline-none"
            />
        </div>
    )
}
