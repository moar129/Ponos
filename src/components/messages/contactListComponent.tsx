      ...
      <div className="p-3 border-b border-border-gray">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-white border border-border-gray rounded-lg pl-9 pr-3 py-2 text-sm text-primary focus:outline-none focus:border-accent transition-colors"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center text-secondary px-4">
            <Users className="w-8 h-8 mb-2 stroke-[1.5] text-secondary" />
            <p className="text-sm">
