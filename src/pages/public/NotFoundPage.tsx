    ...
    return (
        <div className="max-w-xl mx-auto text-center py-16">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link
                    to="/hjaelp"
                    className="inline-flex items-center justify-center rounded-md border border-border-gray px-6 py-3 font-medium text-primary hover:bg-bg-gray transition-colors"
                >
                    Hjælp &amp; support
                </Link>
            </div>
