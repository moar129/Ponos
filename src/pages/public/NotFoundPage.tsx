    ...
    return (
        <div className="max-w-xl mx-auto text-center py-16">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link
                    to="/hjaelp"
                    className="inline-flex items-center justify-center rounded-md border border-slate-700 px-6 py-3 font-medium text-slate-100 hover:bg-slate-800 transition-colors"
                >
                    Hjælp &amp; support
                </Link>
            </div>
