...
export default function ForgotPassword() {
    ...
    return (
        <div className="flex items-center justify-center px-2 py-15 sm:px-6 lg:px-8">
            <form onSubmit={handleSubmit} className="bg-surface border border-slate-800 rounded-lg shadow-md p-8 max-w-md w-full text-slate-100">
                <h1 className="text-xl font-semibold text-slate-100 mb-2">Nulstil adgangskode</h1>
                ...
                <div className="mb-4">
                    <label className="block text-sm text-slate-300 mb-1" htmlFor="firstName">Fornavn</label>
                    <input
                        id="firstName"
                        type="text"
                        value={firstName}
                ...
                <div className="mb-4">
                    <label className="block text-sm text-slate-300 mb-1" htmlFor="lastName">Efternavn</label>
                    <input
                        id="lastName"
                        type="text"
                        value={lastName}
                ...
                <div className="mb-4">
                    <label className="block text-sm text-slate-300 mb-1" htmlFor="password">Ny adgangskode</label>
                    <input
                        id="password"
                        type="password"
                        value={password}
                ...
                <div className="mb-6">
                    <label className="block text-sm text-slate-300 mb-1" htmlFor="confirmPassword">Gentag ny adgangskode</label>
                    <input
                        id="confirmPassword"
                        type="password"
